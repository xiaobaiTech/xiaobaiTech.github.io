...
![](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/8e7e47794e20a373.jpeg)
...
![](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/2b1dc921fecd27e1.gif)
...
![目录](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/send%E7%9B%AE%E5%BD%95.png)
...
![socket_api](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/socket_api.png)
...
![一个socket有两个缓冲区](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/%E4%B8%80%E4%B8%AAsocket%E6%9C%89%E4%B8%A4%E4%B8%AA%E7%BC%93%E5%86%B2%E5%8C%BA.png)
...
![tcp_sendmsg逻辑](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/tcp_sendmsg%E9%80%BB%E8%BE%913.png)
...
![send阻塞](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/send%E9%98%BB%E5%A1%9E.gif)



- 如果此时 socket 是非阻塞的，程序就会**立刻返回**一个 `EAGAIN` 错误信息，意思是  `Try again` , 现在缓冲区满了，你也别等了，待会再试一次。

![send非阻塞](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/send%E9%9D%9E%E9%98%BB%E5%A1%9E.gif)
...
![recv阻塞](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/recv%E9%98%BB%E5%A1%9E.gif)

- 如果此时 socket 是非阻塞的，程序就会**立刻返回**一个 `EAGAIN` 错误信息。

![recv非阻塞](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/recv%E9%9D%9E%E9%98%BB%E5%A1%9E2.gif)

下面用一张图汇总一下，方便大家保存面试的时候用哈哈哈。

![socket读写缓冲区满了的情况汇总](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/socket.png)
...
![TCP四次挥手](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/TCP%E5%9B%9B%E6%AC%A1%E6%8C%A5%E6%89%8B4.png)
...
![recvbuf非空](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/recvbuf%E9%9D%9E%E7%A9%BA.gif)
...
![sendbuf非空](https://cdn.jsdelivr.net/gh/xiaobaiTech/image/sendbuf%E9%9D%9E%E7%A9%BA.gif)
